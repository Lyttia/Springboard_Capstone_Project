...
barplot(months2017)
barplot(months2016)
barplot(months2017[order(months2017, decreasing = TRUE)])
barplot(months2016[order(months2016, decreasing = TRUE)])
```
...
4. Comparisons:
Compare the amounts of theft/burglaries vs violent crimes in each zip code ordered by property value.
