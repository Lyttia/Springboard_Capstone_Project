...
```{r}
barplot(zipcodes[order(crimes$median_value, decreasing = TRUE)])
...
ERROR Frequency of Burglary by zipcode (in descending order)
...
Are any categories more prevalent at a certain time?
...
#ERROR temp <- filter(crimes2017, sub %in% category) # Subset using dplyr
View(temp)
