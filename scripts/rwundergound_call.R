...
getdata4 <- function(location_zip, date_start = "20151108", 
                     date_end = "20151110"){
  df  = history_range(location_zip,date_start,date_end, limit = 10)
  return (df)
}
...
getdata6 <- function(location_zip, date_start = "20151116", 
                     date_end = "20151130"){
  df  = history_range(location_zip, date_start, 
                      date_end, limit = 10)
  return (df)
}
